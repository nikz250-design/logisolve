...
import { MANTENIMIENTOS } from "./mockData";
...
export function FlotaMantenimiento({ T, darkMode }) {
  ...
  const kpis = {
    ...
    costoEstimado: MANTENIMIENTOS.reduce((a, m) => a + m.costo, 0),
  };
            ...
            >
              <div style={{ display: "flex", alignItems: "flex-start", gap: 14, flexWrap: "wrap" }}>
                <div style={{ flex: 1, minWidth: 200 }}>
                  ...
                  <div style={{ fontSize: 11, color: T.textSec }}>Eco. {m.eco} · {m.tecnico}</div>
                  <div style={{ fontSize: 10, color: T.textTer, marginTop: 4 }}>
                    Km programado: {m.kmProg.toLocaleString("es-MX")} km · Km actual: {m.km.toLocaleString("es-MX")} km
                  </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8, flexShrink: 0 }}>
                  ...
                  <div style={{ textAlign: "right" }}>
                    ...
                    <div style={{ fontSize: 13, fontWeight: 700, color: T.text }}>${m.costo.toLocaleString("es-MX")}</div>
                  </div>
                </div>
              </div>
            </motion.div>
